    ...
    <div className="flex h-screen">
      <Sidebar />
       ...
       <main className="flex-1 overflow-y-auto p-10 space-y-16 bg-gradient-to-b from-white to-violet-200">
        <Section 
  id="cover" 
  title="R.U.L.E. - Resume Understanding Language Engine" 
  className="text-5xl font-extrabold p-50 text-center"
>
  <h1 className="text-4xl font-bold mt-6">Project Proposal: Resume Understanding Language Engine</h1>
  <p className="mt-4 text-xl">AI-Powered Resume Parsing and Analysis System</p>
  <p className="text-md mt-2">Date: 30/06/2025</p>
  <div className="mt-6">
    ...
    <ul className="list-disc ml-8 mt-4 space-y-2">
      <li>Dharshan Kumar J – Backend Software Developer</li>
        ...
        <Section id="folders" title="2. File & Folder Descriptions">
          ...
          <Section id="snapshots" title="3. Snapshots">
    ...
    <div className="text-center">
      ...
      />
      <p className="mt-3 text-sm text-gray-700">Front Page of the application interface</p>
    </div>

    {/* Eligible */}
    <div className="text-center">
      <img
        src="/images/Eligible.png"
        alt="Eligible"
        className="w-full max-w-4xl mx-auto h-auto rounded-xl shadow-lg"
      />
      <p className="mt-3 text-sm text-gray-700">Eligible (THE PERSON FITS THE JOB DESCRIPTION)</p>
    </div>

    {/* Not Eligible */}
    <div className="text-center">
      <img
        src="/images/NotEligible.png"
        alt="Not Eligible"
        className="w-full max-w-4xl mx-auto h-auto rounded-xl shadow-lg"
      />
      <p className="mt-3 text-sm text-gray-700">Not Eligible (THE PERSON DOES NOT FIT THE JOB DESCRIPTION)</p>
    </div>
    ...
    <div className="text-center">
      ...
      <img
        ...
        alt="Others 2"
        className="w-full max-w-4xl mx-auto h-auto rounded-xl shadow-lg mt-4"
      />
      <p className="mt-3 text-sm text-gray-700">Others (1 and 2) that contains key skills</p>
    </div>
  </div>
</Section>


        <Section id="pipeline" title="4. Steps in the Pipeline">
        ...
        <Section id="advantages" title="5. Advantages of the System">
        ...
        <Section id="future" title="6. Future Improvements">
        ...
        <Section id="faq" title="7. Frequently Asked Questions (FAQ)">
